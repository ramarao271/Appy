...
class VariantsControllerTest < ActionController::TestCase
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post :create, variant: { price: @variant.price, product_id: @variant.product_id, title: @variant.title, variant_id: @variant.variant_id }
    end
  ...
  test "should update variant" do
    patch :update, id: @variant, variant: { price: @variant.price, product_id: @variant.product_id, title: @variant.title, variant_id: @variant.variant_id }
    assert_redirected_to variant_path(assigns(:variant))
  end
