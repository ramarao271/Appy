...
class ImageFilesControllerTest < ActionController::TestCase
  ...
  test "should create image_file" do
    assert_difference('ImageFile.count') do
      post :create, image_file: { cost: @image_file.cost, image_for: @image_file.image_for, pairs: @image_file.pairs, path: @image_file.path }
    end
  ...
  test "should update image_file" do
    patch :update, id: @image_file, image_file: { cost: @image_file.cost, image_for: @image_file.image_for, pairs: @image_file.pairs, path: @image_file.path }
    assert_redirected_to image_file_path(assigns(:image_file))
  end
