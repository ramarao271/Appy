...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { name: @option.name, option_id: @option.option_id, product_id: @option.product_id, values: @option.values }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { name: @option.name, option_id: @option.option_id, product_id: @option.product_id, values: @option.values }
    assert_redirected_to option_path(assigns(:option))
  end
