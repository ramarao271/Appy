  ...
  def create
    ...
    respond_to do |format|
      if @reward_setting.save
        metafieldStrings={"points_for_registration" => @reward_setting.points_for_registration,"minium_purchase_amount_earn_points" => @reward_setting.minium_purchase_amount_earn_points,"points_earn_for_minimum_amount" => @reward_setting.points_earn_for_minimum_amount,
          "minimum_points_to_redeem" => @reward_setting.minimum_points_to_redeem,"amount_for_minimum_redeem_points" => @reward_setting.amount_for_minimum_redeem_points}
